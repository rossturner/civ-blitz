...
public class LandmarksIndones implements StaticModFile {
	@Override
	public String getFilename() {
		return "ArtDefs/Landmarks_DLC_Indones_Khmer.artdef";
	}
	...
	public String getFileContent() {
		return "<?xml version=\"1.0\" encoding=\"UTF-8\" ?>\n" +
				...
				"\t\t\t\t\t\t\t\t\t\t<m_EntryName text=\"IMP_Khmer_Stilthouse\"/>\n" +
				"\t\t\t\t\t\t\t\t\t\t<m_XLPClass text=\"TileBase\"/>\n" +
				"\t\t\t\t\t\t\t\t\t\t<m_XLPPath text=\"IMP_Khmer_StiltHouse.xlp\"/>\n" +
				"\t\t\t\t\t\t\t\t\t\t<m_BLPPackage text=\"IMP_Khmer_StiltHouse\"/>\n" +
