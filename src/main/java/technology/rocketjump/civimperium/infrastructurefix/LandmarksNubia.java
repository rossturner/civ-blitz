...
public class LandmarksNubia implements StaticModFile {
	@Override
	public String getFilename() {
		return "ArtDefs/Landmarks_DLC_Nubia_Amanit.artdef";
	}
	...
	public String getFileContent() {
		return "<?xml version=\"1.0\" encoding=\"UTF-8\" ?>\n" +
				...
				"\t\t\t\t\t\t\t\t\t\t<m_EntryName text=\"IMP_Nubian_Pyramids\"/>\n" +
				"\t\t\t\t\t\t\t\t\t\t<m_XLPClass text=\"TileBase\"/>\n" +
				"\t\t\t\t\t\t\t\t\t\t<m_XLPPath text=\"IMP_Nubian_Pyramids.xlp\"/>\n" +
				"\t\t\t\t\t\t\t\t\t\t<m_BLPPackage text=\"IMP_Nubian_Pyramids\"/>\n" +
